...
(function () {
      ...
      <div class="row text-center">
        ...
        <div class="col-lg-4 col-12 mb-4">
          <div class="contact-info-item">
            ...
            <h5>WhatsApp</h5>
            <a href="${owner.whatsapp}" target="_blank">${owner.phoneFormatted}</a>
          </div>
        </div>
        <div class="col-lg-4 col-12 mb-4">
          <div class="contact-info-item">
    ...
    `
        ...
        let btns = '';
        if (p.github)
            btns += `<a href="${p.github}" target="_blank" class="btn custom-btn me-2"><i class="bi bi-github me-2"></i>Ver Código</a>`;
        if (p.demo)
            btns += `<a href="${p.demo}" target="_blank" class="btn btn-outline-light"><i class="bi bi-box-arrow-up-right me-2"></i>Demo en Vivo</a>`;
