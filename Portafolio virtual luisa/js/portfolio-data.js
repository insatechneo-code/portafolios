/* ============================================================================
   ...
   No hace falta tocar el HTML ni el CSS para cambiar textos, proyectos o datos.

   PENDIENTES antes de publicar (búscalos como "PENDIENTE"):
     1. Configurar EmailJS  -> sin esto el formulario de contacto no envía nada
     2. Añadir proyectos    -> la sección hoy muestra un mensaje "en preparación"
     3. Revisar las cifras del bloque "Sobre mí" en index.html (años, títulos)
     4. Reemplazar SITE_URL en index.html por la dirección real del sitio
   ============================================================================ */

const PORTFOLIO = {
    // ---- Configuración EmailJS ------------------------------------------------
    // PENDIENTE: mientras diga 'TU_..._AQUI', el formulario avisa al visitante
    // que escriba directo por correo en vez de enviar el mensaje.
    // Cómo obtener los 3 valores (cuenta gratuita):
    //   1) Crear cuenta en https://www.emailjs.com
    //   2) Añadir servicio de correo (Gmail sirve)      -> Service ID
    //   3) Crear plantilla con {{from_name}}, {{from_email}},
    //      {{subject}} y {{message}}                    -> Template ID
    ...
    // ---- Proyectos --------------------------------------------------------------
    // PENDIENTE: `projectCards` (más abajo) está VACÍO a propósito, así que la
    // sección "Mis Proyectos" muestra un mensaje de "en preparación" con enlace a
    // GitHub y al formulario de contacto — en vez de tarjetas cuyos botones no
    // llevaban a ningún repositorio ni demo real.
    //
    // PARA PUBLICAR UN PROYECTO:
    //   1. Completa (o copia) uno de los bloques de abajo.
    //   2. Pon la URL real en `github` y en `demo`. Si todavía no existen,
    //      déjalos como '' — el botón simplemente no aparece, en vez de quedar
    //      muerto apuntando a '#'.
    //   3. Añade su id a `projectCards`, por ejemplo: projectCards: ['portafolio'].
    projects: {
        portafolio: {
            ...
            duration: '1 mes',
            category: 'web',
            // PENDIENTE: enlace al repositorio concreto de este portafolio.
            github: 'https://github.com/Luisa-039',
            // PENDIENTE: URL pública del sitio ya desplegado (antes decía '#hero',
            // que no llevaba a ninguna parte). Déjalo vacío hasta tenerla.
            demo: '',
      ...
      `,
            team: [
                {
                    ...
                    github: 'https://github.com/Luisa-039',
                    email: 'fers86113@gmail.com',
                    whatsapp: 'https://wa.me/573205703024?text=%C2%A1Hola!%20Vi%20tu%20portafolio%20y%20me%20gustar%C3%ADa%20conocer%20m%C3%A1s%20sobre%20tus%20servicios.',
                },
            ],
            extraLinks: [],
            demoAccess: [],
        ...
        gestion: {
            ...
            duration: '2 meses',
            category: 'web',
            // PENDIENTE: URL del repositorio y de la demo. Vacío = el botón no se pinta.
            github: '',
            demo: '',
    ...
    // PENDIENTE: vacío mientras los proyectos no tengan repositorio o demo reales.
    // Cuando estén listos: projectCards: ['portafolio', 'gestion'],
    projectCards: [],
