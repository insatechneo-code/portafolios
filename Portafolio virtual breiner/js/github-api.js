...
(function () {
    ...
    // ========== CONFIGURACIÓN ==========
    const CONFIG = {
        // Apagado a propósito (sep 2026): los repos públicos todavía no aportan nada
        // al portafolio. Ponlo en true para volver a mostrar la sección — el bloque
        // del HTML sigue intacto, no hay que tocar nada más.
        enabled: false,
